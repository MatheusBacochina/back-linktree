...
export interface ApiCursoCurso extends Schema.CollectionType {
  ...
  attributes: {
    titulo: Attribute.String & Attribute.Required & Attribute.DefaultTo<' '>;
    background: Attribute.Media & Attribute.Required;
    subtitulo: Attribute.String & Attribute.Required & Attribute.DefaultTo<' '>;
    ...
    usuarios: Attribute.Decimal & Attribute.DefaultTo<20.2>;
